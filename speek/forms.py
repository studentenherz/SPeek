...
class ChangePasswordForm(FlaskForm):
	...
	new_password_confirmation = PasswordField('Repeat Password', validators=[InputRequired(), Length(min=4, max=20), EqualTo('new_password', message='Unmatching passwords.')	], render_kw={'placeholder' : 'Repeat Password'})
